...
function ReviewModal({
  ...
  return (
    <ReviewsModal open={reviewModal} top={top} ref={modalRef}>
      ...
      <ReviewModalItemContainer>
        ...
        />
        <ReviewModalSection>
          <ReviewModalItemTitle>Adauga un review pentru:</ReviewModalItemTitle>
      ...
      <ReviewInputContainer>
        ...
        <ReviewTextarea>sdsddsdsds</ReviewTextarea>
      </ReviewInputContainer>
