...
function LoginForm(){
    ...
    return <LoginContainer>
        <SignInForm setFocus={setFocus} focus={focus} openLogin={openLogin} setLogin={setLogin}/>
        <RegisterForm setFocus={setFocus} focus={focus} openLogin={openLogin} setLogin={setLogin}></RegisterForm>
    </LoginContainer>
